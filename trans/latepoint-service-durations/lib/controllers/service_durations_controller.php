...
if ( ! class_exists( 'OsServiceDurationsController' ) ) :
  ...
  class OsServiceDurationsController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = __('Service Durations', 'latepoint-service-durations');
      $this->vars['breadcrumbs'][] = array('label' => __('Service Durations', 'latepoint-service-durations'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('service_durations', 'index') ) );
    }
