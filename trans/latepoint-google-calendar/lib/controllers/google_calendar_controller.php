...
if ( ! class_exists( 'OsGoogleCalendarController' ) ) :
  ...
  class OsGoogleCalendarController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = __('Personale Scolastico', 'latepoint-google-calendar');
      $this->vars['breadcrumbs'][] = array('label' => __('Personale Scolastico', 'latepoint-google-calendar'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('agents', 'index') ) );
    }
    ...
    public function load_events_for_sync(){
      ...
      $this->vars['page_header'] = [['label' => __('Bookings in LatePoint', 'latepoint-google-calendar'), 'link' => OsRouterHelper::build_link(['google_calendar', 'list_bookings_for_sync'], ['agent_id' => $agent->id])], 
                                    ['label' => __('Google Calendar Events', 'latepoint-google-calendar'), 'active' => true, 'link' => OsRouterHelper::build_link(['google_calendar', 'load_events_for_sync'], ['agent_id' => $agent->id])]];
    ...
    public function list_bookings_for_sync(){
      ...
      $this->vars['pre_page_header'] = __('Sync for', 'latepoint-google-calendar').' '.$agent->full_name;
      $this->vars['page_header'] = [['label' => __('Bookings in LatePoint', 'latepoint-google-calendar'), 'active' => true, 'link' => OsRouterHelper::build_link(['google_calendar', 'list_bookings_for_sync'], ['agent_id' => $agent->id])], 
                                    ['label' => __('Google Calendar Events', 'latepoint-google-calendar'), 'link' => OsRouterHelper::build_link(['google_calendar', 'load_events_for_sync'], ['agent_id' => $agent->id])]];
    ...
    public function change_agent_calendar(){
      $calendar_id = $this->params['calendar_id'];
      $agent_id = $this->params['agent_id'];
      OsGoogleCalendarHelper::set_selected_calendar_id($calendar_id, $agent_id);
      if($this->get_return_format() == 'json'){
