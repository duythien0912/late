...
final class LatePoint {
  ...
  public function define_constants() {
    ...
    $this->define( 'LATEPOINT_SERVER', 'https://neun46.com');
  ...
  function on_activate() {
    add_role(LATEPOINT_WP_AGENT_ROLE, __('AppoinTy Agent', 'latepoint'));
    ...
    add_role(LATEPOINT_WP_CUSTOMER_ROLE, __('AppoinTy Customer', 'latepoint'));
  ...
  function add_latepoint_link_to_admin_bar( $wp_admin_bar ) {
    ...
    $args = array(
      ...
      // 'title' => '<span class="latepoint-icon latepoint-icon-lp-logo" style="margin-right: 7px; color:#2258ff;"></span><span style="">'.__('AppoinTy', 'latepoint').'</span>',
      'title' => '',
      'href'  => $link,
      'meta'  => array( 'class' => '' )
    );
