...
class OsSettingsHelper {
  ...
  public static function get_default_fields_for_customer(){
    $default_fields = ['first_name' => ['locked' => false, 'label' => __('Nome ', 'latepoint-custom-fields'), 'required' => true, 'width' => 'os-col-6', 'active' => true], 
                      'last_name' => ['locked' => false, 'label' => __('Cognome', 'latepoint-custom-fields'), 'required' => true, 'width' => 'os-col-6', 'active' => true], 
                      'email' => ['locked' => true, 'label' => __('Indirizzo Email', 'latepoint-custom-fields'), 'required' => true, 'width' => 'os-col-6', 'active' => true], 
                      'phone' => ['locked' => false, 'label' => __('Il tuo Numero di Telefono', 'latepoint-custom-fields'), 'required' => false, 'width' => 'os-col-6', 'active' => true], 
