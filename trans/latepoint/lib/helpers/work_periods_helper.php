    ...
    $html.= '<div class="custom-day-work-periods">';
      ...
      $html.= '<a class="add-custom-day-w" '.self::generate_custom_day_period_action(false, false, $args).'>
                <div class="add-custom-day-i">
                  <div class="add-day-graphic-w"><div class="add-day-plus"><i class="latepoint-icon latepoint-icon-plus4"></i></div></div><div class="add-day-label">'.__('Aggiungi giorno', 'latepoint').'</div>
                </div>
              </a>';
