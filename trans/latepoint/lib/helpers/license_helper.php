...
class OsLicenseHelper {
  ...
  public static function get_license_info(){
    ...
    $license['license_key'] = '03c7cec2-323f-4fc7-a58b-e1d73bf76cf0';
    $license['full_name'] = 'Valentino';
    $license['email'] = '33tino@gmail.com';

    $license['is_active'] = OsSettingsHelper::get_settings_value('is_active_license', 'yes');
    $license['status_message'] = OsSettingsHelper::get_settings_value('license_status_message', true);
    $license['status_message'] = 'Plugin is active now. Thank you!';
  ...
  public static function is_license_active(){
    return true;
  	return (OsSettingsHelper::get_settings_value('is_active_license', 'yes') == 'yes');
  }
