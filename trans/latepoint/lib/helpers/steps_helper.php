        ...
        <div class="os-form-w">
          <form data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'update_step'); ?>" action="">
            ...
            <div class="os-form-buttons">
              <?php echo OsFormHelper::button('submit', __('Salva', 'latepoint'), 'submit', ['class' => 'latepoint-btn', 'add_string_to_id' => $step->name]);  ?>
              <a href="#" class="latepoint-btn latepoint-btn-secondary step-edit-cancel-btn"><?php _e('Annulla', 'latepoint'); ?></a>
            </div>
          </form>
        </div>
      </div>
