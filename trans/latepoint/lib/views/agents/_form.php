<div class="os-form-w">
	...
	<?php } ?>
		    <div class="white-box">
		      <div class="white-box-header">
		        <div class="os-form-sub-header">
		        	<h3><?php _e('Informazioni Generali', 'latepoint'); ?></h3>
		      ...
		      <div class="white-box-content">
				    <?php echo OsFormHelper::media_uploader_field('agent[avatar_image_id]', 0, __('Seleziona il tuo Avatar', 'latepoint'), __('Remove Avatar', 'latepoint'), $agent->avatar_image_id); ?>
				    <div class="os-row">
					    <div class="os-col-lg-4"><?php echo OsFormHelper::text_field('agent[first_name]', __('Nome ', 'latepoint'), $agent->first_name); ?></div>
					    <div class="os-col-lg-4"><?php echo OsFormHelper::text_field('agent[last_name]', __('Cognome', 'latepoint'), $agent->last_name); ?></div>
				    ...
				    <div class="os-row">
					    <div class="os-col-lg-4"><?php echo OsFormHelper::text_field('agent[email]', __('Indirizzo Email', 'latepoint'), $agent->email); ?></div>
				    	<div class="os-col-lg-4"><?php echo OsFormHelper::text_field('agent[phone]', __('Il tuo Numero di Telefono', 'latepoint'), $agent->phone); ?></div>
				    </div>
				    <?php if($show_admin_fields){ ?>
					    <div class="os-row">
		    ...
		    <div class="white-box">
		      ...
		      <div class="white-box-content">
		    		<div class="latepoint-message latepoint-message-subtle"><?php _e('Se è necessario avvisare più persone dell\'appuntamento, è possibile elencare indirizzi e-mail e numeri di telefono aggiuntivi a cui inviare e-mail e sms di notifica. Puoi elencare più numeri ed e-mail separati da virgole.', 'latepoint'); ?></div>
				    <div class="os-row">
		    ...
		    <div class="white-box">
		      <div class="white-box-header">
		        <div class="os-form-sub-header">
		        	<h3><?php _e('Informazioni extra', 'latepoint'); ?></h3>
		      	</div>
		      </div>
		      <div class="white-box-content">
		    ...
		    <div class="white-box">
		      <div class="white-box-header">
		        <div class="os-form-sub-header">
		        	<h3><?php _e('Servizi Offerti', 'latepoint'); ?></h3>
		        ...
		        <?php if($locations){
		          foreach($locations as $location){
		            ...
		            if($connected_services_count == $total_services){
		              $services_count_string = __('Tutti', 'latepoint');
		            }else{
		              $services_count_string = $location->is_new_record() ? __('Tutti', 'latepoint') : $connected_services_count.'/'.$total_services;
		            }
		            ?>
		            ...
		            <div class="agent <?php echo $location_active_class; ?>">
		              <div class="agent-i selector-trigger">
		                ...
		                <div class="selected-services" data-all-text="<?php echo __('Tutti', 'latepoint'); ?>">
    ...
    <div class="white-box">
      <div class="white-box-header">
        <div class="os-form-sub-header">
        	...
        	<div class="os-form-sub-header-actions">
        		<?php echo OsFormHelper::checkbox_field('is_custom_schedule', __('Imposta pianificazione personalizzata', 'latepoint'), 'on', $is_custom_schedule, array('data-toggle-element' => '.custom-schedule-wrapper')); ?>
        	</div>
      	</div>
      </div>
      <div class="white-box-content">
    ...
    <?php if(!$agent->is_new_record()){ ?>
		    ...
		    <div class="white-box">
		      <div class="white-box-header">
		        <div class="os-form-sub-header"><h3><?php _e('Giorni con orari ', 'latepoint'); ?></h3></div>
		      </div>
		      <div class="white-box-content">
		    ...
		    <div class="white-box">
		      <div class="white-box-header">
						<div class="os-form-sub-header"><h3><?php _e('Giorni di permesso o feriali', 'latepoint'); ?></h3></div>
		      </div>
		      <div class="white-box-content">
    ...
    <?php 
      if($agent->is_new_record()){
        ...
        echo OsFormHelper::button('submit', __('Aggiungi Personale Scolastico', 'latepoint'), 'submit', ['class' => 'latepoint-btn']); 
      }else{
