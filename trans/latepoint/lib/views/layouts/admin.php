...
if($logged_in_admin_user_type == LATEPOINT_WP_ADMIN_ROLE){
	...
	$logged_in_user_last_name = $logged_in_admin_user->last_name;
	...
	$logged_in_user_last_name = $logged_in_agent->last_name;
	$logged_in_user_avatar_url = $logged_in_agent->avatar_url;
	$logged_in_user_role = __('Personale Scolastico', 'latepoint');
