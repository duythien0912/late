...
<div class="ch-day-booking status-<?php echo $booking->status; ?>" <?php echo $action_html; ?> style="top: <?php echo $booking_start_percent; ?>%; height: <?php echo $booking_duration_percent; ?>%; background-color: <?php echo $booking->service->bg_color; ?>; <?php echo $left; ?>">
	...
	<div class="ch-day-booking-i" data-id="<?php echo $booking->id ?>"
	data-service-name="<?php echo $booking->service->name ?>"
	data-agent-fullname="<?php echo $agent->full_name ?>"
	data-service-time="<?php echo OsTimeHelper::minutes_to_hours_and_minutes($booking->start_time); ?> - <?php echo OsTimeHelper::minutes_to_hours_and_minutes($booking->end_time); ?>"
	>
