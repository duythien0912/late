    ...
    <div class="side-by-side-buttons">
      <div class="os-row">
        ...
        <div class="os-col-lg-6">
          <button type="button" data-os-after-call="latepoint_wizard_item_editing_cancelled" data-os-output-target=".os-wizard-step-content" data-os-params="current_step=services" data-os-action="<?php echo OsRouterHelper::build_route_name('wizard', 'load_step'); ?>" class="wizard-finished-editing-trigger latepoint-btn latepoint-btn-lg latepoint-btn-secondary"><?php _e('Annulla', 'latepoint'); ?></button>
        </div>
        <?php } ?>
