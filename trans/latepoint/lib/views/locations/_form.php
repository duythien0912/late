<div class="os-form-w">
  <form action="" data-os-success-action="redirect" data-os-redirect-to="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('locations', 'index')); ?>" data-os-action="<?php echo $location->is_new_record() ? OsRouterHelper::build_route_name('locations', 'create') : OsRouterHelper::build_route_name('locations', 'update'); ?>">
    ...
    <div class="white-box">
      <div class="white-box-header">
        <div class="os-form-sub-header">
          <h3><?php _e('Informazioni ', 'latepoint'); ?></h3>
      ...
      <div class="white-box-content">
        <div class="os-row">
          <div class="os-col-lg-4">
            <?php echo OsFormHelper::text_field('location[name]', __('Nome', 'latepoint'), $location->name); ?>
          ...
          <div class="os-col-lg-8">
            <?php echo OsFormHelper::text_field('location[full_address]', __('Indirizzo', 'latepoint'), $location->full_address); ?>
    ...
    <div class="white-box">
      <div class="white-box-header">
        <div class="os-form-sub-header">
          <h3><?php _e('Seleziona personale scolastico in questa sede', 'latepoint'); ?></h3>
        ...
        <?php if($agents){
          foreach($agents as $agent){
            ...
            if($services_count == count($services)){
              ...
              $services_count_string = $location->is_new_record() ? __('Tutti', 'latepoint') : $services_count.'/'.count($services);
            }
            ?>
    ...
    <div class="white-box">
      <div class="white-box-header">
        <div class="os-form-sub-header">
          <h3><?php _e('Pianificazione della posizione', 'latepoint'); ?></h3>
          <div class="os-form-sub-header-actions">
