<div class="os-form-w">
  ...
  <form action="" data-os-action="<?php echo OsRouterHelper::build_route_name('updates', 'save_license_information'); ?>">
		<?php if($license['status_message']){ ?>
			...
			<?php } ?>
		<?php }else{
			echo '<div class="os-form-message-w"><ul><li>'.__('Please enter your AppoinTy license key to receive free plugin updates and install addons.', 'latepoint').'</li></ul></div>';
		} ?>
  	<div class="os-row">
  		<div class="os-col-lg-6">
				<?php echo OsFormHelper::password_field('license[full_name]', __('Your Name', 'latepoint'), $license['full_name']); ?>
			</div>
  		<div class="os-col-lg-6">
				<?php echo OsFormHelper::password_field('license[email]', __('Your Email Address', 'latepoint'), $license['email']); ?>
  		</div>
  	</div>
  	<div class="os-row">
  		<div class="os-col-12">
				<?php echo OsFormHelper::password_field('license[license_key]', __('License Key', 'latepoint'), $license['license_key']); ?>
  		</div>
  	</div>
