...
<div class="latepoint-settings-w os-form-w">
  <form action="" data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'update'); ?>">
    <div class="os-tp-box">
      ...
      <div class="os-tp-box-content">
        ...
        <div class="lp-form-checkbox-contents lp-notification-agent-confirmation" <?php echo (OsSettingsHelper::get_settings_value('notification_agent_confirmation') == 'on') ? '' : 'style="display: none;"' ?>>
          <?php echo OsFormHelper::text_field('settings[notification_agent_new_booking_notification_subject]', __('Oggetto della mail', 'latepoint'), OsNotificationsHelper::agent_new_booking_notification_subject()); ?>
        ...
        <div class="lp-form-checkbox-contents lp-notification-agent-booking-status-changed" <?php echo (OsSettingsHelper::get_settings_value('notification_agent_booking_status_changed') == 'on') ? '' : 'style="display: none;"' ?>>
          <?php echo OsFormHelper::text_field('settings[notification_agent_booking_status_changed_notification_subject]', __('Oggetto della mail', 'latepoint'), OsNotificationsHelper::agent_booking_status_changed_notification_subject()); ?>
    ...
    <div class="os-tp-box">
      ...
      <div class="os-tp-box-content">
        ...
        <div class="lp-form-checkbox-contents lp-notification-customer-booking-confirmation" <?php echo (OsSettingsHelper::get_settings_value('notification_customer_confirmation') == 'on') ? '' : 'style="display: none;"' ?>>
          <?php echo OsFormHelper::text_field('settings[notification_customer_booking_confirmation_subject]', __('Oggetto della mail', 'latepoint'), OsNotificationsHelper::customer_booking_confirmation_subject()); ?>
        ...
        <?php echo OsFormHelper::checkbox_field('settings[notification_customer_booking_status_changed]', __('Abilita email di Cambiamento Status Appuntamento con l\'Utente', 'latepoint'), 'on', (OsSettingsHelper::get_settings_value('notification_customer_booking_status_changed') == 'on'), array('data-toggle-element' => '.lp-notification-customer-booking-status-changed')); ?>
        <div class="lp-form-checkbox-contents lp-notification-customer-booking-status-changed" <?php echo (OsSettingsHelper::get_settings_value('notification_customer_booking_status_changed') == 'on') ? '' : 'style="display: none;"' ?>>
          <?php echo OsFormHelper::text_field('settings[notification_customer_booking_status_changed_notification_subject]', __('Oggetto della mail', 'latepoint'), OsNotificationsHelper::customer_booking_status_changed_notification_subject()); ?>
    ...
    <div class="os-tp-box">
      <div class="os-tp-box-header">
        <div class="os-form-sub-header"><h3><?php _e('Altre email dei clienti', 'latepoint'); ?></h3></div>
      </div>
      <div class="os-tp-box-content">
        <h3><?php _e('Richiesta di Reset della Password', 'latepoint'); ?></h3>
        <?php echo OsFormHelper::text_field('settings[email_customer_password_reset_request_subject]', __('Oggetto della mail', 'latepoint'), OsNotificationsHelper::customer_password_reset_request_subject()); ?>
