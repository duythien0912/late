      ...
      <div class="appointment-box-large status-<?php echo $booking->status; ?>" data-booking-id="<?php echo $booking->id; ?>" <?php echo OsBookingHelper::quick_booking_btn_html($booking->id); ?>>
        ...
        <div class="account-info-w">
          <div class="account-info-head">
            ...
            <div class="account-name-w">
              <div class="account-info-label"><?php _e('Personale Scolastico', 'latepoint'); ?></div>
        ...
        <div class="account-info-w">
          <div class="account-info-head">
            ...
            <div class="account-name-w">
              <div class="account-info-label"><?php _e('Utente', 'latepoint'); ?></div>
...
<?php }else{ ?>
  <div class="no-results-w">
    ...
    <h2><?php _e('Nessun appuntamento in sospeso trovato', 'latepoint'); ?></h2>
    <a href="#" <?php echo OsBookingHelper::quick_booking_btn_html(); ?> class="latepoint-btn"><?php _e('Crea un appuntamento', 'latepoint'); ?></a>
  </div>
<?php } ?>
