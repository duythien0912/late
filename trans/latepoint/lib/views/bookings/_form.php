<div class="os-form-w">
  <form action="" data-os-action="<?php echo ($booking->is_new_record()) ? OsRouterHelper::build_route_name('bookings', 'create') : OsRouterHelper::build_route_name('bookings', 'update'); ?>" class="booking-quick-edit-form">
    ...
    <div class="os-form-content">
      ...
      <div class="os-row">
        <div class="os-col-6">
          <?php echo OsFormHelper::text_field('booking[start_date]', __('Data ', 'latepoint'), $booking->start_date); ?>
        </div>
        <div class="os-col-6">
      ...
      <div class="os-row">
        <div class="os-col-6">
          <?php echo OsFormHelper::text_field('booking[start_time]', __('Orario di Inizio', 'latepoint'), $booking->start_time); ?>
          <?php echo OsFormHelper::text_field('booking[end_time]', __('Orario di Fine', 'latepoint'), $booking->end_time); ?>
        </div>
        <div class="os-col-6">
      ...
      <div class="customer-info-w <?php echo ($booking->customer->id) ? 'selected': 'editing'; ?>">
        ...
        <div class="os-form-sub-header"><h3><?php _e('Utente', 'latepoint'); ?></h3></div>
    ...
    <div class="os-form-buttons">
      ...
      echo '<a href="#" class="latepoint-btn latepoint-btn-secondary">'.__('Annulla', 'latepoint').'</a>';
