...
<?php }else{ ?>
  <div class="no-results-w">
    ...
    <h2><?php _e('Non ci sono Utenti in Database', 'latepoint'); ?></h2>
    <a href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('customers', 'new_form') ) ?>" class="latepoint-btn"><i class="latepoint-icon latepoint-icon-plus"></i><span><?php _e('Aggiungi Utente', 'latepoint'); ?></span></a>
  </div>
<?php } ?>
