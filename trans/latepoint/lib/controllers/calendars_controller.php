...
if ( ! class_exists( 'OsCalendarsController' ) ) :
  ...
  class OsCalendarsController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = [['label' => __( 'Appuntamenti del Giorno', 'latepoint' ), 'icon' => '', 'link' => OsRouterHelper::build_link(['calendars', 'daily_agents'])],
                                    ['label' => __( 'Appuntamenti della Settimana', 'latepoint' ), 'icon' => '', 'link' => OsRouterHelper::build_link(['calendars', 'weekly_agent'])],
                                    ['label' => __( 'Appuntamenti del Mese', 'latepoint' ), 'icon' => '', 'link' => OsRouterHelper::build_link(['calendars', 'monthly_agents'])]];
    ...
    function daily_agents(){
      $this->vars['breadcrumbs'][] = array('label' => __('Appuntamenti del Giorno', 'latepoint'), 'link' => false );
    ...
    function monthly_agents(){
      $this->vars['breadcrumbs'][] = array('label' => __('Monthly Calendar', 'latepoint'), 'link' => false );
    ...
    function weekly_agent(){
      $this->vars['breadcrumbs'][] = array('label' => __('Appuntamenti della settimana', 'latepoint'), 'link' => false );
