...
if ( ! class_exists( 'OsSettingsController' ) ) :
  ...
  class OsSettingsController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['breadcrumbs'][] = array('label' => __('Impostazioni', 'latepoint'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('settings', 'general') ) );
    }
    ...
    public function work_periods(){
      ...
      $this->vars['breadcrumbs'][] = array('label' => __('Impostazioni del programma di lavoro', 'latepoint'), 'link' => false );
    ...
    public function general(){
      ...
      $this->vars['breadcrumbs'][] = array('label' => __('Generale', 'latepoint'), 'link' => false );
