...
if ( ! class_exists( 'OsServiceCategoriesController' ) ) :
  ...
  class OsServiceCategoriesController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = __('Le Categorie dei Servizi', 'latepoint');
      $this->vars['breadcrumbs'][] = array('label' => __('Le Categorie dei Servizi', 'latepoint'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('service_categories', 'index') ) );
    }
