...
if ( ! class_exists( 'OsAgentsController' ) ) :
  ...
  class OsAgentsController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = __('Personale Scolastico', 'latepoint');
      $this->vars['breadcrumbs'][] = array('label' => __('Personale Scolastico', 'latepoint'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('agents', 'index') ) );
    }
