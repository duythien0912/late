...
if ( ! class_exists( 'OsLocationsController' ) ) :
  ...
  class OsLocationsController extends OsController {
    ...
    function __construct(){
      ...
      $this->vars['page_header'] = __('Le mie Sedi', 'latepoint');
      $this->vars['breadcrumbs'][] = array('label' => __('Le mie Sedi', 'latepoint'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('locations', 'index') ) );
    }
    ...
    */
    ...
    public function new_form(){
      $this->vars['page_header'] = __('Crea una nuova sede', 'latepoint');
      $this->vars['breadcrumbs'][] = array('label' => __('Crea una nuova sede', 'latepoint'), 'link' => false );
